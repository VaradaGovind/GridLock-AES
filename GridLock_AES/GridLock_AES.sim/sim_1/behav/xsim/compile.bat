...
REM
REM Generated by Vivado on Thu Apr 02 08:58:25 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj aes_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj aes_tb_vlog.prj -log xvlog.log
